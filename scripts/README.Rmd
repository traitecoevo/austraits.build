...
- ` `r sprintf("austraits-%s.zip", get_version())` `: data in plain text format (.csv, .bib, .yml files). Suitable for anyone, including those using Python. 
- ` `r sprintf("austraits-%s.rds", get_version())` `: data as compressed R object. Suitable for users of R (see below).
