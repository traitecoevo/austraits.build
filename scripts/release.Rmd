...
austraits::flatten_database(austraits) %>% readr::write_rds(austraits_flattened-X.X.X.rds)

austraits_flattened %>% arrow::write_parquet(austraits_flattened-X.X.X.parquet)

create_release(austraits, v_prev = "7.0.0")
```
 - the function above creates a set of files for release, including `austraits-X.X.X.rds`, `austraits_flattened-X.X.X.rds`, `austraits_flattened-X.X.X.parquet`, `austraits-X.X.X.zip`, `dictionary.html`, `news.md`
