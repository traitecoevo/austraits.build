...
testthat::test_that("test datasets", {
  ...
  Catford_2014 <- test_build_dataset(file.path(root.dir, "data/Catford_2014/metadata.yml"), file.path(root.dir, "data/Catford_2014/data.csv"), "Catford_2014")
  Falster_2005_1 <- test_build_dataset(file.path(root.dir, "data/Falster_2005_1/metadata.yml"), file.path(root.dir, "data/Falster_2005_1/data.csv"), "Falster_2005_1")
  
  expect_no_error({austraits1 <- austraits.build:::combine_datasets(Catford_2014, Falster_2005_1, definitions=definitions)}, 
  ...
  Ex1 <- test_build_dataset(file.path(examples.dir, "test1-metadata.yml"), file.path(examples.dir, "test1-data.csv"), "Example 1")
  ...
  Ex2 <- test_build_dataset(file.path(examples.dir, "test2-metadata.yml"), file.path(examples.dir, "test1-data.csv"), "Example 2")
  ...
  Ex3 <- test_build_dataset(file.path(examples.dir, "test2.1-metadata.yml"), file.path(examples.dir, "test2-data.csv"), "Example 3")
  ...
  Ex4 <- test_build_dataset(file.path(examples.dir, "test2.1-metadata.yml"), file.path(examples.dir, "test3-data.csv"), "Example 4")
  ...
  Ex5 <- test_build_dataset(file.path(examples.dir, "test3-metadata.yml"), file.path(examples.dir, "test3-data.csv"), "Example 5")
