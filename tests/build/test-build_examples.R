...
testthat::test_that("test datasets", {
  ...
  Catford_2014 <- test_build_dataset(file.path(root.dir, "data/Catford_2014/metadata.yml"), file.path(root.dir, "data/Catford_2014/data.csv"), "Catford_2014", trait_definitions, unit_conversions, schema)
  Falster_2005_1 <- test_build_dataset(file.path(root.dir, "data/Falster_2005_1/metadata.yml"), file.path(root.dir, "data/Falster_2005_1/data.csv"), "Falster_2005_1", trait_definitions, unit_conversions, schema)
  ...
  Ex1 <- test_build_dataset(file.path(examples.dir, "test1-metadata.yml"), file.path(examples.dir, "test1-data.csv"), "Example 1", trait_definitions, unit_conversions, schema)
  ...
  Ex2 <- test_build_dataset(file.path(examples.dir, "test2-metadata.yml"), file.path(examples.dir, "test1-data.csv"), "Example 2", trait_definitions, unit_conversions, schema)
  ...
  Ex3 <- test_build_dataset(file.path(examples.dir, "test2.1-metadata.yml"), file.path(examples.dir, "test2-data.csv"), "Example 3", trait_definitions, unit_conversions, schema)
  ...
  Ex4 <- test_build_dataset(file.path(examples.dir, "test2.1-metadata.yml"), file.path(examples.dir, "test3-data.csv"), "Example 4", trait_definitions, unit_conversions, schema)
  ...
  Ex5 <- test_build_dataset(file.path(examples.dir, "test3-metadata.yml"), file.path(examples.dir, "test3-data.csv"), "Example 5", trait_definitions, unit_conversions, schema)
