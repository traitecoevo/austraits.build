...
if(length(context_properties) > 0 ) {
    ...
    for (i in seq_along(context_properties)) {      
        paste("The column titled, `r metadata$contexts[[i]]$var_in`, in your dataset was mapped to context property, `r metadata$contexts[[i]]$context_property`, within the category, `r metadata$contexts[[i]]$category`") %>% writeLines()
