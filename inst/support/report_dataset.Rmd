...
# Variable to record when trait_definitions have been specified
...
```{r, results='asis', echo=FALSE}
#ifelse(is.null(metadata_study$contributors$assistants), NA , writeLines("In addition, the following people are included as assistants: ", metadata_study$contributors$assistants))
```


The AusTraits data curator(s) for this dataset is:  `r metadata_study$contributors$austraits_curators`
