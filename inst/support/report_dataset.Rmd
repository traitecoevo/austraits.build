...
```{r, results='asis', echo=FALSE}
#ifelse(is.null(metadata$contributors$assistants), NA , writeLines("In addition, the following people are included as assistants: ", metadata$contributors$assistants))
```


The AusTraits data curator(s) for this dataset is:  `r metadata$contributors$austraits_curators`
...
traits_numeric <- traits[extract_list_element(traits, trait_definitions, "type") == "numeric"]
traits_categorical <- traits[extract_list_element(traits, trait_definitions, "type") != "numeric"]
```
