...
if(length(context_properties) > 0 ) {
  context_properties %>%
    for (i in 1:length(context_properties)) {      
      writeLines("The column titled `r context_properties[[i]]$category[1]` in your dataset was mapped to context property `r context_properties[[i]]$context_property[1]`, within the category `r context_properties[[i]]$category[1]`")
