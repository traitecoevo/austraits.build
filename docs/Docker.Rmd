---
title: Docker container for reproducible compute environment 
date: "`r Sys.Date()`"
output:
  github_document:
    html_preview: false
...
This document provides information on using Docker. Separate documents provide information on: 
