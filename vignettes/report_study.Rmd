...
define_variable <- function(var, definitions) {
  ...
  description <- switch(var,
                        ...
                        replicates = definitions$austraits$elements$data$elements$replicates,
                        methods = definitions$austraits$elements$details$elements$methods
                        )
...
if(!is.null(data_yaml$taxonomic_updates) & !is.na(data_yaml$taxonomic_updates)) {
