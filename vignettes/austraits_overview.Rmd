...
* Fields capture value type (mean, min, max, mode, range, bin) and associated replicate numbers, basis of value (measurement, expert_score, literature), entity type (species, population, individual), life stage (adult, juvenile,sapling, seedling), collection type (field, experiment, museum collection), and any additional measurement remarks. 
* A field, observation number, indicates if repeat measures were made on the samw individual over time.
* A field, method number, indicates if the same trait was measured using multiple methods.
