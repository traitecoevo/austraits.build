...
AusTraits is an open-source, harmonised database of Australian plant trait data. Traits vary in scope from physiological measures of performance
(e.g. photosynthetic gas exchange, water-use efficiency) to morphological attributes (e.g. leaf area, seed mass, plant height).
