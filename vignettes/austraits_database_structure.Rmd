...
## traits {#traits}
```{r}
elements <- austraits$schema$austraits$elements$traits
...
#### Entity IDs, entity type, observation number and method number
...
- `entity_type` indicates whether the entity being measured is an individual, population, species, or higher order taxa. 
...
#### Values, Value types, and basis of value {#value_types}
...
Each trait measurement has an associated `value_type`, which is ``r austraits$schema$value_type$description`` Possible values are:

```{r value_type}
austraits$schema$value_type$values %>%
  list1_to_df() %>%
  my_kable_styling() %>%
  writeLines()
```

Each trait measurement also has an associated `basis_of_value`, which is ``r austraits$schema$basis_of_value$description`` Possible values are: 

```{r basis_of_value}
austraits$schema$basis_of_value$values %>%
  list1_to_df() %>%
  my_kable_styling() %>%
  writeLines()
```
...
## sites
```{r}
elements <- austraits$schema$austraits$elements$sites
...
## contexts
```{r}
elements <- austraits$schema$austraits$elements$contexts
...
## methods {#methods}
```{r}
elements <- austraits$schema$austraits$elements$methods
...
## exluded_data
```{r}
elements <- austraits$schema$austraits$elements$excluded_data
...
```{r}
elements <- austraits$schema$austraits$elements$taxa
...
```{r}
elements <- austraits$schema$austraits$elements$taxonomic_updates
...
## definitions
```{r}
elements <- austraits$schema$austraits$elements$trait_definitions
...
## contributors
```{r}
elements <- austraits$schema$austraits$elements$contributors
...
## build_info
```{r}
elements <- austraits$schema$austraits$elements$build_info
