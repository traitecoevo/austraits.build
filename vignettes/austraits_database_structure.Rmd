...
Each trait measurement has an associated `entity_type`, which is `r tolower(schema$metadata$elements$traits$elements$entity_type)` Possible values are: 
...
#### Values, Value types, basis of value, basis of record {#value_types}
