...
- You collected data on one of the traits listed in the [trait definitions table](http://traitecoevo.github.io/austraits.build/articles/definitions.html)
...
To successfully compile AusTraits you need to source a series of functions written explicitly for the database:

```{r, eval=FALSE, echo=TRUE}
source("scripts/custom.R")        # functions used in custom_R_code
source("scripts/taxonomy.R")      # functions required to load taxonomic resources and update taxonomy
```
...
- the [list of trait definitions](http://traitecoevo.github.io/austraits.build/articles/definitions.html)
