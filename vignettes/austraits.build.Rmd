...
The main purpose of this repo is to build  `AusTraits`, a curated database of traits for Australian Flora. It contains code and data to build the harmonised AusTraits database outputs. So, the intended audiences are those who are interested in building AusTraits from scratch, or contributing data to AusTraits.
...
1.  Increases our collective understanding of Australian flora; and
