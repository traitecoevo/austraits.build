...
Anyone wishing to extend AusTraits data will need to begin by building AusTraits to create a current compiled dataset. Below, under [Approach](#approach) we describe conceptually how individual datasets are merged into the complete AusTraits compilation, and under [Structure](#format) the format of the each file. The section [Rebuilding](#building) then explains how to  actually build Austraits, while [Add. The structure of the data files is described un , as described un 
