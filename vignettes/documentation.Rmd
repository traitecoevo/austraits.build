...
**year_collected_start:** `r sprintf(austraits$definitions$austraits$elements$methods$elements$year_collected_start)`

**year_collected_end:** `r austraits$definitions$austraits$elements$methods$elements$year_collected_end`

**description:** `r austraits$definitions$austraits$elements$methods$elements$description`

**collection_type:** `r austraits$definitions$austraits$elements$methods$elements$collection_type`

**sample_age_class:** `r austraits$definitions$austraits$elements$methods$elements$sample_age_class`

**sampling_strategy:** `r austraits$definitions$austraits$elements$methods$elements$sampling_strategy`
...
```{r B14}
traits_B14 <- extract_dataset(austraits, "Blackman_2014")
```
