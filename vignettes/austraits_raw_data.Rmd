...
The file `definitions.yml` defines the structure of the database and all terms. There are three main sections to the `definitions.yml` file, the trait definitions used to compile AusTraits, allowable trait values, and definitions of all elements included in the tables that comprise AusTraits. The [trait definitions](http://traitecoevo.github.io/austraits.build/articles/Trait_definitions.html) and [definitions of all elements in AusTraits (and value types)](http://traitecoevo.github.io/austraits.build/articles/austraits_structure.html) are fully described in additional vignettes. A `.yml` file is a structured data file where information is presented in a hierarchical format (see [appendix for details](#yaml)). 
