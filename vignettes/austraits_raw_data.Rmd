...
The file `species_list.csv` is our master list of known taxa. Each species is listed once, with known IDs (see [section above](#taxonomic) for details). 
...
Note that in these first examples only `primary` is included. If a secondary source is included it may look like:
