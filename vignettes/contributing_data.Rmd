...
•	**Data sourced from others:** For numeric traits, AusTraits strives to only include data collected by you for this project, to avoid having multiple entries of the same trait observation. If you certain trait values were sourced from the literature, an online database, or lab mates, please indicate that clearly. If trait values for some species were collected by you and others were sourced, add a column to your spreadsheet that indicates the source for different rows of data.
