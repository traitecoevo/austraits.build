...
By far our preferred way of contributing is for you to contyribute files directly into the repository and then send a  [pull request](https://help.github.com/articles/using-pull-requests/) with you input. You can do this by

- (for approved mainatianers of austraits.build) Creating a branch, or
