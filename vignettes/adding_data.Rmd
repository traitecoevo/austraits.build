...
5. Although site properties are not restricted to a controlled vocabulary, newly added studies should use the same site property syntax as others whenever possible, to allow future discoverability. To generate a list of already used under `location_property`, use: 

```
austraits$sites %>% distinct(location_property)
```
