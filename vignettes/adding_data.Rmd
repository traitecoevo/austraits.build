...
Context properties are formatted much like site properties, where the context name (generated above) is simply a container for a unique combination of context property values.
...
2. As with site data, extract a list of unique context property combinations from the data.csv file
...
3. Although context properties are not restricted to a controlled vocabulary, newly added studies should use the same context property syntax as others whenever possible, to allow future discoverability. To generate a list of terms already used under `context_property`, use: 
...
1. Add `[manipulated]` to context properties that represent experimental manipulations.

2. Ensure that the value of each context property is clear. 
