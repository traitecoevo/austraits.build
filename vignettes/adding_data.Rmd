...
XXX-Daniel: the remake austraits line previously was "austraits <- readRDS("export/data/austraits.rds")" which failed
...
This sections explains how to format files to contribute a new study to AusTraits. Before starting this, you should read more about the [structure of the compiled AusTraits database](http://traitecoevo.github.io/austraits.build/articles/austraits_structure.html), the [structure of the raw data files](http://traitecoevo.github.io/austraits.build/articles/austraits_raw_data.html), and [how to build AusTraits](http://traitecoevo.github.io/austraits.build/articles/austraits.build.html).
XXX - Daniel, the "how to build" used to link to "building_austraits.md" - I don't know where this file resides. Is the link I used OK?
...
XXX-Daniel: I've changed these links - confirm these are what you intended. 
