...
source("R/custom.R")            # source functions written for use within custom_R_code
...
- source the file containing functions the AusTraits team have explicitly developed to use within the custom_R_code field: `source("R/custom.R")`
