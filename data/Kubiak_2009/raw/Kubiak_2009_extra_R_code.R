...
wide_data %>% 
  mutate(
    ...
    secondary_juvenile_period = case_when(
      ...
      str_detect(secondary_juvenile_period, "y") ~ str_extract(secondary_juvenile_period, "[0-9\\-]+(?=y)"),
